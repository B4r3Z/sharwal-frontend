  ...
  return (
    <div className=" flex items-center w-[97.5%] mx-auto gap-8">
      <img
        ...
        className="border-8 border-mySecondary"
      />
      <div className="flex flex-col w-full self-start">
        <div className=" flex flex-col gap-y-32">
          <div className="flex flex-col items-start">
            <div className="flex flex-col -space-y-12 items-start ">
              <h1 className="text-mySecondary font-satoshiBold text-[8.125rem] leading-[10rem]">
                MADE IN
              </h1>
              <h2 className="text-mySecondary font-satoshiBold text-[8.125rem] leading-[10rem]">
                KURDISTAN
              </h2>
            </div>
            <p className="font-dentonReg text-mySecondary text-[2.625rem] leading-10 tracking-[-0.02em]">
